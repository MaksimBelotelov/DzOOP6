...
import ru.gb.oseminar.data.UserSortings;
...
public class StudentController implements UserController<Student>{
    ...
    public void getSortedListStudentFromStudentGroup(){
        List<Student> students = UserSortings.getSortedStudentGroup(studentGroupService
                                                                    .getStudentGroup()
                                                                    .getStudents());
    ...
    public void getSortedListByFIOStudentFromStudentGroup(){
        List<Student> students = UserSortings.getSortedByFIOStudentGroup(studentGroupService
                                                                        .getStudentGroup()
                                                                        .getStudents());
        studentView.sendOnConsole(students);
    }
